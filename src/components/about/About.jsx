...
import "./about.css";
import Me from "../../assets/profilePicSq.png";
        ...
        <div className="about_content">
          <div className="about_cards">
            ...
            <article className="about_card">
              ...
              <h5>Skills in</h5>
              <small>Full Stack Evironment</small>
            </article>
            <article className="about_card">
          ...
          <p>
            My name is Thomas Wright. I am a Full Stack Developer out of New
            Jersey. I have a passion for creating modern yet attractive UI. I
            started freelancing web design for local business around me and grew
            to have a hunger to learn more.
            <br />
            <br />
